...
public class ProtonWave extends Actor
{
    ...
    /**
     * grow will increase the size of the proton wave until it reaches it's 
     * maximum size, at which point it will remove itself from the world
     * 
    ...
    /**
     * checkCollision sees if our Proton Wave has touched an asteroid and deals damage
     * to each asteroid it touches
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
